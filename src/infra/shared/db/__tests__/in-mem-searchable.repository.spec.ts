...
import { SearchParams } from "../../../../domain/shared/repository/search-params";
import { SearchResult } from "../../../../domain/shared/repository/search-result";
import { ValueObject } from "../../../../domain/shared/value-object";
import { UUID } from "../../../../domain/shared/value-objects/uuid.vo";
import { InMemorySearchableRepository } from "../in-mem.repository";
...
> {
  ...
  insert(entity: StubEntity): Promise<void> {
    throw new Error("Method not implemented.");
  }
  bulkInsert(entities: StubEntity[]): Promise<void> {
    throw new Error("Method not implemented.");
  }
  update(entity: StubEntity): Promise<void> {
    throw new Error("Method not implemented.");
  }
  delete(entityId: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  findById(entityId: UUID): Promise<StubEntity | null> {
    throw new Error("Method not implemented.");
  }
  findAll(): Promise<StubEntity[]> {
    throw new Error("Method not implemented.");
  }
  ...
  describe("search method", () => {
    ...
    it("should apply paginate and filter", async () => {
      ...
      let result = await repository.search(
        new SearchParams<string>({ page: 1, perPage: 2, filter: "TEST" })
      );
      expect(result).toStrictEqual(
        new SearchResult({
